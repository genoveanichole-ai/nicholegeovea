...
<body>
  <div>
    <h1>💫 Welcome to <span style="color:#FFD700;">Student Info </span></h1>
...
<head>
  ...
  <style>
    ...
    .student-card h5 { color: #FFD700; margin-bottom: 10px; }
    .student-card p { margin: 3px 0; }
    .btn-delete {
      background: #FF4C4C;
      border: none;
      border-radius: 50px;
